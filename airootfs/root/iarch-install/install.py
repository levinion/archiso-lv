...
def complete_hint():
    print("Installation is done. There's something you could do:")
    print("1. install graphic drivers")
    print("2. install and enable your preferred display manager")
    print("3. update the whole system with pacman -Syyuu")
